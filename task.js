class Task {
  ...
  createTask () {
    ...
    insertElement.innerHTML =
      ...
      + '<button class="btn btn-xs btn-success downBtn" onClick="taskStatusChange(' + this.id + ',\'down\')">◀</button>'
      + '<button class="btn btn-xs btn-success upBtn"   onClick="taskStatusChange(' + this.id + ',\'up\')">▶</button>'
      + '</span>'
